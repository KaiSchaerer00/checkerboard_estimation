...
n_list <- c(100, 250, 1000, 2500, 10000)
s <- 0.8
sim_rep <- 1000
m <- 2000
...
for (method in c("max", "mean")) {
  ...
  save_name <- sprintf("mean_regression_convergence_%s.pdf", method)
  ggsave(save_name, width = 16, height = 4, dpi = 400)
}

saveRDS(df_cb_max, file = "mean_regression_convergence_df_cb_max.rds")
saveRDS(df_cb_mean, file = "mean_regression_convergence_df_cb_mean.rds")
saveRDS(df_alt_max, file = "mean_regression_convergence_df_nw_max.rds")
saveRDS(df_alt_mean, file = "mean_regression_convergence_df_nw_mean.rds")

df_cb_max <- readRDS("mean_regression_convergence_df_cb_max.rds")
df_cb_mean <- readRDS("mean_regression_convergence_df_cb_mean.rds")
df_alt_max <- readRDS("mean_regression_convergence_df_nw_max.rds")
df_alt_mean <- readRDS("mean_regression_convergence_df_nw_mean.rds")
